...
A.localeStrings = {
	enUS = {
		...
		helpText = "Slash commands: /announcer, /announcer options, /announcer announce, /announcer debug",
		openedOptions = "Opened Announcer options.",
		usage = "Usage: /announcer options|announce|debug",
	...
	koKR = {
		...
		helpText = "슬래시 명령어: /announcer, /announcer options, /announcer announce, /announcer debug",
		openedOptions = "Announcer 설정을 열었습니다.",
		usage = "사용법: /announcer options|announce|debug",
		statusChannel = "채널",
		statusMode = "방식",
		outcomeMiss = "빗나감",
		outcomeDodge = "회피",
